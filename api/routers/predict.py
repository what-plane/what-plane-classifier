...
async def image_prediction_api(
    ...
    try:
        imagenet_probs, imagenet_classes, imagenet_likely_class = model.predict_imagenet(
            image, topk=5
        )
        ...
        raise HTTPException(status_code=400, detail="Unable to predict on provided UUID")
